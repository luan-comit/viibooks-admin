...
const AddBarber = () => {
  const [barberImg, setDocImg] = useState(false)
  ...
  const [speciality, setSpeciality] = useState("Traditional barber")
        ...
        <div className="flex items-center gap-4 mb-8 text-gray-500">
          <label htmlFor="barber-img">
            <img
              ...
              src={
                barberImg ? URL.createObjectURL(barberImg) : assets.upload_area
              }
              alt=""
            />
          </label>
